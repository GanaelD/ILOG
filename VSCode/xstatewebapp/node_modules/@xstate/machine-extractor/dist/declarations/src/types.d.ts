...
export declare type Location = t.SourceLocation | null;
...
export interface Parser<T extends t.Node = any, Result = any> {
    parse: (node: t.Node | undefined | null, context: ParserContext) => Result | undefined;
...
export declare type DeclarationType = "named" | "inline" | "identifier" | "unknown";
