...
export declare type GetObjectKeysResult<T extends {
...
export declare type GetParserResult<TParser extends AnyParser<any>> = NonNullable<ReturnType<TParser["parse"]>>;
/**
